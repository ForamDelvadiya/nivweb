                ...
                <div class="container">
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="inrpgtitle">
                            <h3><span>UI/UX Designer</span></h3>
                        </div>
                        <div class="bnrimg">
            ...
            <div class="container">
                    ...
                    <div class="col-12">
                        <div class="section-title-and-desc">
                            <div class="section-title-block">
                                <h1 class="section-title-text mt-5"><b>Embedded UI/UX Designer</b></h1><br>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="row">
                    ...
                    <div class="col-lg-6 mb-5">
                        ...
                        <p>We are looking for a skilled UI/UX Designer Lead with expertise in both Automation Testing and Manual Testing to join our team. The ideal candidate will have extensive experience in leading UI/UX Designing teams, developing test strategies, and ensuring the quality of our software products.</p>
                        <p></p>
                        ...
                        <ul class="style-icon">
                            <li>Lead the UI/UX Designing team and oversee all aspects of the quality assurance process.</li>
                            ...
                            <li>Mentor and train UI/UX Designing team members on best practices and new technologies.</li>
                        ...
                        <ul class="style-icon"><li>Bachelor's degree in Computer Science, Engineering, or related field.</li>
                            <li>2 to 3 Years of experience in UI/UX Designer, with a focus on both Automation and Manual Testing.</li>
                            <li>Proven experience leading UI/UX Designing teams and managing projects.</li>
                            <li>Strong knowledge of software UI/UX Designermethodologies, tools, and processes.</li>
